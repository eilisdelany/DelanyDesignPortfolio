export default {
  title: 'Say whattt?',
  content: [{
    quote: `People hold you in very high regard and know that you are a person who can be trusted to do an exceptional job, who is remarkably professional and organised and who always exceeds expectations. I think you have great grace and poise in how you conduct yourself and am grateful to you for everthing you bring to the studio and to The Dock.`,
    name: 'Lorna Ross',
    ...
    quote: `Eilís did a great job of owning the Second Family concept during frantic times. Excelled at understanding all research to date, pulling key insights and creating Mindsets. Also a lot of fun to be around. Never flustered, always suggesting next steps and taking the initiative to push on the project.`,
    name: 'Shane Delahunty',
    role: 'Service and Interaction Associate Manager',
    company: 'Fjord Dublin'
  }, {
    quote: `Eilís' professional approach and sincere interest in using user-centered design brought continuous quality in this very ambiguous project. She displayed an outstanding ability to learn rapidly and adapt quickly to changing situations in the project. She established effective working relations with the Analytics and Software teams to include their POV's and outputs into the design process. She also built strong relationships with key stakeholders of the project.`,
    name: 'Firat Toroglu',
